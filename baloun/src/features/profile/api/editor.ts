...
import type { ProfileRow, Tag } from '@/services/supabase/types'
 ...
 * IMPORTANTE: il profilo mostrato a schermo arriva dallo store della sessione,
 * quindi va aggiornato anche quello — altrimenti il salvataggio funziona
 * ma la selezione non cambia finché non si riapre l'app.
 */
