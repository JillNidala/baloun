...
export function ProfileCard({ main, onDecide, disabled, showHint }: Props) {
  return (
    <article className="flex min-h-[112dvh] flex-col px-6">
      ...
      {/* 3 e 4 — Interessi (lista estensibile) */}
      <div className="mx-auto mt-10 w-full max-w-sm divide-y divide-hairline border-y border-hairline">
        {main.interests.map((interest) => (
