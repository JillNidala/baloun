...
export type Tag = { slug: string; label: string; icon: string }
export type Prompt = { id: string; label: string; answer: string }
export type Photo = { path: string; position: number }
